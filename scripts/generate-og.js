...
const OUTPUT_FILE = path.join(OUTPUT_DIR, 'share.png');
...
async function generateSingleImage() {
	...
	try {
		...
		// Composizione dell'SVG trasparente con il titolo sopra lo screenshot del gradiente reale corale
		await sharp(BG_PATH)
			.resize(1200, 630)
		...
		console.log(`✅ Immagine di anteprima ufficiale generata con successo -> share.png`);
	} catch (error) {

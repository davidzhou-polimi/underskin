 ...
 * @param {number} [paddingX=8] Margine di sicurezza orizzontale dai bordi in pixel
 * @param {number} [paddingY=100] Margine di sicurezza verticale dai bordi in pixel
 */

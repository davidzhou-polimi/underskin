...
export function outroReveal(node, params) {
	...
	// Commento solo il PERCHÉ: su mobile la sezione diventa un carosello a pulsante alto 100svh
	// (vedi outroCarouselMobile.js): il trigger tarato sul contenitore da 800vh non deve esistere.
	...
	return {
		destroy() {
			mm.revert(); // revert() esegue anche le cleanup dei singoli branch matchMedia
		}
	};
}
